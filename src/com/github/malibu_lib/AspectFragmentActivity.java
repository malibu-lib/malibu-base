...
import com.github.malibu_lib.internal.FragmentActivityPointcutManager;

@SuppressLint("Registered")
public class AspectFragmentActivity extends FragmentActivity implements Pointcut {

    // Pointcut definition

    private final FragmentActivityPointcutManager pointcutManager = new FragmentActivityPointcutManager(
            this);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        pointcutManager.onCreateContextMenu(menu, v, menuInfo);
    }

    @Override
    public boolean onContextItemSelected(MenuItem item) {
        return pointcutManager.onContextItemSelected(item);
